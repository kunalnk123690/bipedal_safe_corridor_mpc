...
#else
  #define CASADI_PREFIX(ID) B_gen_ ## ID
#endif
...
static const casadi_int casadi_s0[3] = {36, 20, 1};
...
CASADI_SYMBOL_EXPORT casadi_int B_n_in(void) { return 0;}
...
CASADI_SYMBOL_EXPORT int B_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
